        ...
        stage('Environment Setup') {
            steps {
                withPythonEnv('python3') {
                    ...
                    echo "\n<--------- Installing PyTorch... --------->"
                    sh 'pip3 install torch torchvision torchaudio --extra-index-url https://download.pytorch.org/whl/cpu'
                    echo "\n<--------- Installing requirements.txt --------->"
                    sh 'pip3 install -r requirements.txt --no-cache-dir --index-url http://192.168.50.25:8081/repository/Workstation_PyPi/ --trusted-host 192.168.50.25'
                    echo '\n=====================\n[END] Initializing...\n=====================\n'
                }
            }
        }
