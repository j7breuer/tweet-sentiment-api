        ...
        stage('Environment Setup') {
            steps {
                withPythonEnv('python3.9') {
                    ...
                    sh 'pip3.9 install -r requirements.txt --no-cache-dir --index-url http://admin:admin@192.168.50.25:8081/repository/Workstation_PyPi/ --trusted-host 192.168.50.25'
                    echo '\n=====================\n[END] Initializing...\n=====================\n'
                }
            }
        }
